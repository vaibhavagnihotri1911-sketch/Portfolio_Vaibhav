            ...
            <div className="project-card-body">
              ...
              <div className="project-tech-row">
                {project.tech.map((t, i) => (
                  <span key={i} className="project-tech-chip">{t}</span>
                ))}
              </div>

              <div className="project-card-footer">
                <a href={project.github} target="_blank" rel="noreferrer" className="project-view">
                  View on GitHub →
                </a>

                <a href={project.live} target="_blank" rel="noreferrer" className="project-live-btn">
                  Live ↗
                </a>
              ...
              {/* ✅ ADDITION ONLY (extra CTA row) */}
              <div className="project-extra-row">
                <span className="project-extra-text">Explore full implementation & source code</span>
              </div>
